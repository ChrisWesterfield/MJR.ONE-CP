...
class Dns
{
    ...
    use IdTrait;
    /**
     * @ORM\OneToOne(targetEntity="\Mjr\Library\EntitiesBundle\Entity\Customer\Main", inversedBy="Dns", fetch="EXTRA_LAZY")
     ...
     * @ORM\JoinTable(name="customer_dns_host",
     *     joinColumns={
     *          @ORM\JoinColumn(name="host_id", referencedColumnName="id")
     *     },
