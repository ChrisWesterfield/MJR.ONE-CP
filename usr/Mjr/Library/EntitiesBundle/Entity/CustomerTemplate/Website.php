...
/**
 * @ORM\Table(name="template_customer_website")
 * @ORM\Entity()
 * @Gedmo\Loggable
...
class Website
{
    ...
    use IdTrait;
    /**
     * @ORM\OneToOne(targetEntity="\Mjr\Library\EntitiesBundle\Entity\CustomerTemplate\Main", inversedBy="Website", fetch="EXTRA_LAZY")
     ...
     * @ORM\JoinTable(name="template_customer_website_host",
     *     joinColumns={
     *          @ORM\JoinColumn(name="host_id", referencedColumnName="id")
     *     },
