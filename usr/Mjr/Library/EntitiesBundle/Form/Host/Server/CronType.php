...
class CronType extends AbstractType
{
    ...
    {
        $builder
            ->add('CronInitScriptName',TextType::class)
            ->add('PathForIndividualCronTabs',TextType::class)
            ->add('PathToWgetProgramm',TextType::class)
        ;
    }
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => 'Mjr\Library\EntitiesBundle\Entity\Host\Server\Cron'
        ));
    }
}
