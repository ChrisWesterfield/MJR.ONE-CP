...
namespace Mjr\Library\ProfilerBundle\EventListener;

use Mjr\Library\ProfilerBundle\DataCollector\XhprofCollector;
...
class RequestListener
{
    ...
    public function onCoreResponse(FilterResponseEvent $event)
    {
        ...
        $headerName = $this->container->getParameter('mjr_library_profiler.response_header');
        if ($headerName) {
