...
$xhprof_runs_impl = new XHProfRuns_DefaultXHPROFGUI();
...
while ($row = XHProfRuns_DefaultXHPROFGUI::getNextAssoc($domainsRS))
{
...
while ($row = XHProfRuns_DefaultXHPROFGUI::getNextAssoc($serverRS))
{
