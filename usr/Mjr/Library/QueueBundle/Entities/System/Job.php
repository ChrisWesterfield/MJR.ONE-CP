...
namespace Mjr\Library\QueueBundle\Entities\System;

use Doctrine\Common\Collections\ArrayCollection;
use Doctrine\ORM\Mapping as ORM;
use Mjr\Library\QueueBundle\Exception\InvalidStateTransitionException;
use Mjr\Library\QueueBundle\Exception\LogicException;
use Symfony\Component\Debug\Exception\FlattenException;

/**
 * @ORM\Entity(repositoryClass = "Mjr\Library\QueueBundle\Entities\Repository\System\JobRepository")
 * @ORM\Table(name = "system_jobs", indexes = {
...
class Job
{
     ...
     * @ORM\JoinTable(name="system_job_dependencies",
    ...
    /** @ORM\Column(type = "mjr_library_queue_safe_object", name="stackTrace", nullable = true) */
    private $stackTrace;
