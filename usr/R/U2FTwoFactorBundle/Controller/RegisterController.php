...
class RegisterController extends Controller
{
    ...
    {
        $u2fAuthenticator = $this->get('ru2_f_two_factor.authenticator');
        if ($request->isMethod('POST')) {
            ...
            $dispatcher->dispatch('ru2_f_two_factor.register', $event);
        ...
        return $this->render($this->container->getParameter('ru2_f_two_factor.registerTemplate'), array(
